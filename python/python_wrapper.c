...
static PyObject *_write_raw_meta(struct bpak_package *pkg, uint32_t meta_id,
                                 uint32_t part_ref_id, uint8_t *buffer,
                                 size_t length)
{
    int rc;
    ...
    if (rc != BPAK_OK || meta == NULL) {
        ...
        if (length > meta_header->size) {
            PyErr_SetString(BPAKPackageError,
                            "Growing meta data is currently not supported");
            return NULL;
        }
                                        ...
                                        PyObject *kwds)
{
    ...
    return _write_raw_meta(&package->pkg,
                           meta_id,
                           part_ref_id,
                           (uint8_t *)meta_data_in,
                           meta_data_sz);
}
...
static PyObject *package_write_uuid_meta(PyObject *self, PyObject *args)
{
    ...
    return _write_raw_meta(&package->pkg, meta_id, part_ref_id, uuid_raw, 16);
}
...
static PyObject *package_sign(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    rc = PyArg_ParseTupleAndKeywords(args, kwds, "s", kwlist, &sign_key_path);
...
static PyObject *package_transport_encode(PyObject *self, PyObject *args,
                                          PyObject *kwds)
{
    int rc;
...
static PyObject *package_transport_decode(PyObject *self, PyObject *args,
                                          PyObject *kwds)
{
    int rc;
    static char *kwlist[] = {"origin", "output", NULL};
...
static PyObject *package_read_signature(PyObject *self,
...
static PyMethodDef package_methods[] = {
    ...
    {"read_digest", package_read_digest, METH_NOARGS, "Get package digest"},

    {"read_signature",
     package_read_signature,
     METH_NOARGS,
     "Get package signature"},

    {"close", package_close, METH_NOARGS, "Close package"},

    {"read_hash_kind", package_hash_kind, METH_NOARGS, "Get package hash kind"},

    {"set_hash_kind",
     (PyCFunction)(void (*)(void))package_set_hash_kind,
     METH_VARARGS | METH_KEYWORDS,
     "Sets package hash kind"},

    {"set_signature_kind",
     (PyCFunction)(void (*)(void))package_set_sign_kind,
     METH_VARARGS | METH_KEYWORDS,
     "Sets package signature kind"},

    {"set_signature",
     (PyCFunction)(void (*)(void))package_set_signature,
     METH_VARARGS | METH_KEYWORDS,
     "Sets package signature data"},

    {"set_key_id",
     (PyCFunction)(void (*)(void))package_set_key_id,
     METH_VARARGS | METH_KEYWORDS,
     "Sets key id"},

    {"set_keystore_id",
     (PyCFunction)(void (*)(void))package_set_keystore_id,
     METH_VARARGS | METH_KEYWORDS,
     "Sets keystore id"},
    ...
    {"transport_encode",
     (PyCFunction)(void (*)(void))package_transport_encode,
     METH_VARARGS | METH_KEYWORDS,
     "Encode package for transport"},

    {"transport_decode",
     (PyCFunction)(void (*)(void))package_transport_decode,
     METH_VARARGS | METH_KEYWORDS,
     "Decode transport encoded package"},

    {"installed_size",
     (PyCFunction)(void (*)(void))package_installed_size,
     METH_NOARGS,
     "Return the installed size of the archive"},

    {"read_raw_meta",
     (PyCFunction)(void (*)(void))package_read_raw_meta,
     METH_VARARGS | METH_KEYWORDS,
     "Read meta data"},

    {"write_raw_meta",
     (PyCFunction)(void (*)(void))package_write_raw_meta,
     METH_VARARGS | METH_KEYWORDS,
     "Write meta data"},

    {"write_string_meta",
     (PyCFunction)(void (*)(void))package_write_string_meta,
     METH_VARARGS,
     "Write string meta data"},

    {"read_string_meta",
     (PyCFunction)(void (*)(void))package_read_string_meta,
     METH_VARARGS,
     "Read string meta data"},

    {"write_uuid_meta",
     (PyCFunction)(void (*)(void))package_write_uuid_meta,
     METH_VARARGS,
     "Write uuid meta data"},

    {"read_uuid_meta",
     (PyCFunction)(void (*)(void))package_read_uuid_meta,
     METH_VARARGS,
     "Read uuid meta data"},
    {NULL},
};
...
static PyTypeObject BPAKPackageType = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "bpak.Package",
    .tp_doc = "BPAK Package",
...
static PyObject *m_id(PyObject *module, PyObject *args, PyObject *kwds)
{
    ...
    rc = PyArg_ParseTupleAndKeywords(args, kwds, "s", kwlist, &input_string);
    if (!rc) {
        PyErr_SetString(BPAKPackageError, "Invalid argument");
        return NULL;
    }
