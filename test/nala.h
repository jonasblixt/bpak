...
#define TEST(name)                                                             \
    ...
    static struct nala_test_t nala_test_##name = {.name_p = #name,             \
                                                  .func = name,                \
                                                  .before_fork_func =          \
                                                      name##_before_fork,      \
                                                  .next_p = NULL};             \
    __attribute__((constructor)) void nala_constructor_##name(void)            \
    {                                                                          \
...
#define NALA_CHECK_SUBSTRING(left, right) nala_check_substring(left, right)
...
__attribute__((noreturn)) void nala_test_failure(const char *file_p, int line,
