...
#       But only run the transport decoding step
#
# Purpose: To test that 'patch' files that have transport coding meta data
#       but are not actually transport coded can pass through the decode
#       step.
#

#!/bin/bash
BPAK=../src/bpak
TEST_NAME=test_transport4
TEST_SRC_DIR=$1/test
